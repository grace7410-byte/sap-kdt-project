...
| 구분 | 오브젝트명 | 베이스 | 설명 | 코드 |
| --- | --- | --- | --- | --- |
| Search Help | `ZI_B07_MTART_F4` | I_MaterialType | 자재타입 Value Help (FERT/HALB/ROH/HAWA/HIBE/VERP만 노출) | - |
| Search Help | `ZI_B07_WERKS_F4` | T001W + T001K | 플랜트 Value Help (회사코드 K200 기준) | - |
| Search Help | `ZI_B07_LGORT_F4` | I_StorageLocation | 저장위치 Value Help (플랜트에 종속) | - |
| Search Help | `ZI_B07_BKLAS_F4` | I_Prodvaluationclass | 평가클래스 Value Help (3000/3300/7900/7920) | - |
