...
| Behavior Definition | `ZR_B07_MARA` / `ZC_B07_MARA` | - | Managed, with draft. Field Control + Determination(SetInitialDefault/SetReadOnly) 완료, Validation 4종은 TODO | [`ZR_B07_MARA.bdef.asbdef`](https://github.com/grace7410-byte/sap-kdt-project/blob/main/src/01_material-mgmt/bdef/ZR_B07_MARA.bdef.asbdef) |
| Behavior Implementation | `ZBP_R_B07_MARA` | - | `SetInitialDefault`, `SetReadOnly` 구현 완료. Validation 로직(validate_matnr 등)은 진행중 | [`zbp_r_b07_mara.clas.abap`](https://github.com/grace7410-byte/sap-kdt-project/blob/main/src/01_material-mgmt/bimp/zbp_r_b07_mara.clas.abap) |
