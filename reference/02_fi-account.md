...
| Root BO | `ZR_B07_SKA1` | ZTB07SKA1 | RAP Root Entity, Text Table Composition + 계정타입/회사코드/조정계정유형 텍스트 Association 포함 | [`ZR_B07_SKA1.ddls.asddls`](https://github.com/grace7410-byte/sap-kdt-project/blob/main/src/02_fi-account/cds/ZR_B07_SKA1.ddls.asddls) |
...
| Projection | `ZC_B07_SKA1` | ZR_B07_SKA1 | OData V2 노출용 Root (회사코드/통화/조정계정유형 서치헬프까지 완료) | [`ZC_B07_SKA1.ddls.asddls`](https://github.com/grace7410-byte/sap-kdt-project/blob/main/src/02_fi-account/cds/ZC_B07_SKA1.ddls.asddls) |
...
> 회사코드는 SKA1 자체보다 다른 곳(예: 벤더의 조정계정 연결)에서 활용할 때 Validation이 필요해질 것으로 보임 (2026-08-21 메모)
