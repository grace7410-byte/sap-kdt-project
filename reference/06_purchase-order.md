...
| Projection | `ZC_B07_EKKO` | ZR_B07_EKKO | OData V4 노출용 Root. 검색조건 3개(구매오더일/공급업체/구매오더번호), Sort(구매오더일desc→공급업체→구매오더번호), Value Help 7종(공급업체/회사코드/구매조직/구매그룹/문서유형/통화/구매오더번호) 연결(구매그룹/문서유형은 테스트(2)에서 Projection 재선언으로 해결), `_Ekpo`를 `ZC_B07_EKPO`로 redirect, `SetDeletionFlag` 액션 노출 | [`ZC_B07_EKKO.ddls.asddls`](https://github.com/grace7410-byte/sap-kdt-project/blob/main/src/06_purchase-order/cds/ZC_B07_EKKO.ddls.asddls) |
...
- 이후 실제 CRUD/채번/Validation/Instance Feature 동작 테스트(테스트(2))를 진행해 다음 오류들을 발견하고 해결함: Loekz 체크박스 미표시(Interface View에서 `cast(... as abap_boolean preserving type)` 처리), Ekorg 서치헬프 결합텍스트로 인한 20자 제한 오류, Ekgrp/Bsart Value Help 미표시(Projection에 재선언 필요), 아이템 생성 시 `RAISE_SHORTDUMP`(WAERS 정적 readonly 충돌 + early numbering `mapped` 구조체 `%is_draft` 누락). 자세한 내용은 [2026-09-08 개발일지](../devlog/rap-dev/2026-09-08.md) 참고.
- `ZR_B07_EKKO.bdef.asbdef`의 `authorization master ( instance )` 선언은 최종 코드에서 실제로 사용됨을 확인 — 05번 패턴을 참고해 추가한 것이 맞았음(이전 체크포인트의 미해결 이슈 해소).
- 남은 후순위 항목: 지급조건(Zterm)/인코텀즈(Inco1) Value Help 미구현, 구매오더내역(Pdesc) 서치헬프 미적용.

관련 Search Help: [`ZI_B07_EKORG_F4`](./00_common-searchhelp.md), [`ZI_B07_EKGRP_F4`](./00_common-searchhelp.md), [`ZI_B07_BUKRS_F4`](./00_common-searchhelp.md), [`ZI_B07_WAERS_F4`](./00_common-searchhelp.md), [`ZI_B07_LIFNR_F4`](./00_common-searchhelp.md), [`ZI_B07_WERKS_F4`](./00_common-searchhelp.md), [`ZI_B07_LGORT_F4`](./00_common-searchhelp.md), [`ZI_B07_EBELN_F4`](./00_common-searchhelp.md), [`ZI_B07_INFNR_F4`](./00_common-searchhelp.md), [`ZI_B07_INSMK_F4`](./00_common-searchhelp.md), [`ZI_B07_EPSTP_F4`](./00_common-searchhelp.md), [`ZI_B07_MWSKZ_F4`](./00_common-searchhelp.md), [`ZI_B07_POSTAT_F4`](./00_common-searchhelp.md), [`ZI_B07_KNTTP_F4`](./00_common-searchhelp.md), [`ZI_B07_BSART_F4`](./00_common-searchhelp.md) · 공급업체는 [벤더관리](./03_vendor.md), 구매정보레코드는 [구매정보레코드관리](./05_purchase-info.md) 참조
